...
public class Notification {
    ...
    public Notification(String libelle_notification, String objet_notification) {
        this.libelle_notification = libelle_notification;
        this.objet_notification = objet_notification;
    }

    public Notification(String libelle_notification, Date date_notification, String objet_notification) {
        this.libelle_notification = libelle_notification;
    ...
    public Notification(String libelle_notification, Date date_notification, String objet_notification,int id_voiture) {
        this.libelle_notification = libelle_notification;
        this.date_notification = date_notification;
        this.objet_notification = objet_notification;
    ...
    public Notification(int id_notification, String libelle_notification, Date date_notification, String objet_notification,int id_voiture) {
        this.id_notification = id_notification;
        this.libelle_notification = libelle_notification;
        this.date_notification = date_notification;
        this.objet_notification = objet_notification;
