...
public class InscriUserController implements Initializable {
    ...
    { 
        ...
        else if (userDAO.findByEmail(email)==true){
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Erreur");
            alert.setHeaderText("Email deja utiliser");
            alert.setContentText("Veulliez utiliser un nouveau email");
            TrayNotification tray = new TrayNotification("Erreur", " Veulliez utiliser un nouveau email",NotificationType.ERROR);
